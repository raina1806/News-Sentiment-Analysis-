...
st.title("\U0001F4F0 AI-Powered News Aggregator with Sentiment Analysis")

# Add sidebar for branding and filters
with st.sidebar:
    st.header("Customize Your Feed")
    query = st.text_input("\U0001F50D Search News:", "AI")
...
articles = fetch_news(config.API_KEY, query=query)
